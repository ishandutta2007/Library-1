...
template <typename M> struct SegmentTree_Dual {
 ...
 SegmentTree_Dual() {}
 SegmentTree_Dual(int n_, T v1= T()): n(n_), height(ceil(log2(n))), val(n, v1), laz(n * 2, {E(), false}) {}
 SegmentTree_Dual(const std::vector<T> &v): n(v.size()), height(ceil(log2(n))), val(v), laz(n * 2, {E(), false}) {}
