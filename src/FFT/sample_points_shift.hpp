...
template <class mod_t, std::size_t LM= 1 << 22> std::vector<mod_t> sample_points_shift(const std::vector<mod_t>& y, mod_t c, int m= 1) {
 ...
 mod_t* x= GlobalArray<mod_t, LM, 0>::bf;
